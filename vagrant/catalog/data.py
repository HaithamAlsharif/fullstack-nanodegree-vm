...
engine = create_engine('sqlite:///coffeeshop.db')
...
restaurant1 = Coffeeshop(name="Urban Burger")
...
restaurant2 = Coffeeshop(name="Super Stir Fry")
...
restaurant1 = Coffeeshop(name="Panda Garden")
...
menuItem2 = MenuItem(
    ...
    description="""a common Chinese dumpling which generally consists of minced
     meat and finely chopped vegetables wrapped into a piece of dough skin.
...
menuItem3 = MenuItem(
    ...
    description="""The most prominent differences between
     Japanese-style gyoza and
    Chinese-style jiaozi are the rich garlic flavor,
    which is less noticeable in the Chinese version,
    the light seasoning of Japanese gyoza with salt and soy sauce,
...
restaurant1 = Coffeeshop(name="Thyme for That Vegetarian Cuisine ")
...
menuItem1 = MenuItem(
    ...
    sweet milk and topped with vanilla bean
...
menuItem4 = MenuItem(
    ...
    garlic sauce cooked with fresh cilantro,
...
restaurant1 = Coffeeshop(name="Tony\'s Bistro ")
...
# Menu for Andala's
restaurant1 = Coffeeshop(name="Andala\'s")
...
restaurant1 = Coffeeshop(name="Auntie Ann\'s Diner ")
...
menuItem9 = MenuItem(
    ...
    description="""Fresh battered sirloin steak
...
menuItem4 = MenuItem(
    ...
    and seasoned with a spicy mix(chilli, tamarind among others)
     and slow cooked in a cylindrical clay or
...
restaurant1 = Coffeeshop(name="Cocina Y Amor ")
...
menuItem2 = MenuItem(
    ...
    usually stuffed with queso telita or
